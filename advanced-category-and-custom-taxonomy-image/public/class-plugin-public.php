...
class Advanced_Category_And_Custom_Taxonomy_Image_Public
{
	...
	public function ad_tax_image_shortcode_callback( $atts )
	{
		...
		return Advanced_Category_And_Custom_Taxonomy_Image::get_taxonomy_image( intval( $attr['term_id'] ), filter_var( $attr['return_img_tag'], FILTER_VALIDATE_BOOLEAN ), explode( ' ', esc_attr( $attr['class'] ) ) );
	}
}
